...
class JobPostingsControllerTest < ActionController::TestCase
  ...
  test "should create job_posting" do
    assert_difference('JobPosting.count') do
      post :create, job_posting: { description: @job_posting.description, job_benchmark_id: @job_posting.job_benchmark_id, title: @job_posting.title, user_id: @job_posting.user_id }
    end
  ...
  test "should update job_posting" do
    patch :update, id: @job_posting, job_posting: { description: @job_posting.description, job_benchmark_id: @job_posting.job_benchmark_id, title: @job_posting.title, user_id: @job_posting.user_id }
    assert_redirected_to job_posting_path(assigns(:job_posting))
  end
